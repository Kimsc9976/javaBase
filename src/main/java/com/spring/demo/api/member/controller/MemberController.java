...
public class MemberController {
    ...
    @Operation(summary = "이메일 중복확인", description = "이메일이 중복이 되는지 확인합니다.", tags = {"View"})
    ...
    @Operation(summary = "이메일 인증[이메일 전송]", description = "이메일이 중복이 되는지 확인을 위한 메일 전송을 진행합니다..", tags = {"View"})
    ...
    @Operation(summary = "이메일 인증[이메일 확인]", description = "이메일이 중복이 되는지 확인합니다.", tags = {"View"})
    ...
    @PostMapping("/signout")
    @Operation(summary = "로그 아웃", description = "버튼 클릭시 로그아웃 진행", tags = {"View"})
